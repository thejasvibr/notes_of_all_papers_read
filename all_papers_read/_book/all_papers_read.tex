...
- Reports of dogs that found their way back even when displaced beyond their usual home range, and without access to familar visual cues.
...
\item
  Small dogs were used, and so there was no `physical thresat' to wild animals
\item
...
\item
  dogs returning with a scouting strategy seemed to begin by first travelling along the north-south axis, irrespective of the actual locationg ot he destination
  \#\#\# Discussion
\item
...
\subsection{Overall thoughts / Comments}\label{overall-thoughts-comments}}
