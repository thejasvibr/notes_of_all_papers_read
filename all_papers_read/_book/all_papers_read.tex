...
\item
  ...
  \end{itemize}
\item
  \emph{``If bats coordinate flight relying on their spatial memory rather than acoustic sensing, there would be no remarkable differences in the learned flight behaviours between the acoustically permeable wall and reflective wall conditions.''} . Not really. See Comments {[}1{]}
\end{itemize}
...
\item
  asdf ;lkj asdf ;lkj asdf ;lkj adsf ;lkj asdf ;lkj
\end{enumerate}
